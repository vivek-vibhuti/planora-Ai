...
export default function BookingManager({ hotels = [], destination }: BookingManagerProps) {
  ...
  useEffect(() => {
    ...
    setBookingForm((p) => ({ ...p, checkIn: d.checkIn, checkOut: d.checkOut }));
  }, []);
          ...
          <CardContent>
            {bookingStatus === 'success' && bookingResponse?.success ? (
              ...
              <div className="bg-red-50 border border-red-200 rounded-lg p-6 text-center">
                ...
                <h3 className="text-lg font-semibold text-red-900 mb-2">Booking Request Failed</h3>
                <p className="text-red-800 mb-4">{bookingResponse?.error || 'Unable to submit booking request.'}</p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        ...
                        <textarea
                          ...
                          rows={3}
                          className="w-full rounded-xl border-2 border-gray-300 px-4 py-3 focus:border-green-500 focus:ring-2 focus:ring-green-200 focus:outline-none"
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-blue-50 rounded-lg p-4">
                    <h4 className="font-semibold text-blue-900 mb-2">Hotel Contact</h4>
                  ...
                  <div className="bg-green-50 rounded-lg p-4">
                    <h4 className="font-semibold text-green-900 mb-2">Booking Tips</h4>
  ...
  return (
    <div className="space-y-6">
      <header className="text-center mb-4">
        <h2 className="text-2xl font-bold text-gray-900 mb-2">Recommended Hotels in {destination}</h2>
          ...
          <Card key={idx} className="overflow-hidden hover:shadow-xl transition-shadow">
            ...
            <CardContent className="pt-0">
              <div className="space-y-4">
                ...
                <section>
                  <h4 className="font-medium text-gray-900 mb-1">Why Recommended</h4>
                ...
                {hotel.bookingTips && (
                  <section className="bg-green-50 rounded-lg p-3">
                    <h4 className="font-medium text-green-900 mb-1">Booking Tip</h4>
